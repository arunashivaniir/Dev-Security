...
Server-sent events (SSE) let your browser get live updates from a server, such as news or sports scores, without asking each time—updates arrive automatically. The browser uses something called EventSource to keep the connection open and receive new messages as they happen.